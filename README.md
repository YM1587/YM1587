...
🌐 Web Development: HTML, CSS, JavaScript (Weather App, QR Code Generator)

🛠️ Technologies: JavaFX, REST APIs, MVC Architecture, DAO Pattern

🤖 AI & Logic Programming: Prolog, Python

⚡ Currently Learning: Advanced Java Backend, Expert Systems

🛠️ Projects
🚍 Bus Booking System (JavaFX) – A desktop-based ticket booking system

🌦️ Weather App – Fetches real-time weather data using JavaScript

🔳 QR Code Generator – Simple JavaScript tool to generate QR codes

🤖 AI Knowledge Base – A Prolog-based system for university queries

📫 Let's Connect!
💼 https://www.linkedin.com/in/eugine-onyango-765766261/

📂 Portfolio

📧eugineogutu004@gmail.com 
